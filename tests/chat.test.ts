...
test.describe('chat activity', () => {
  ...
  test('send a user message and receive response', async () => {
    ...
    expect(assistantMessage.content).toContain("Grass is green because it contains a pigment called chlorophyll");
  });
  ...
  test('edit user message and resubmit', async () => {
    ...
    const assistantMessage = await chatPage.getRecentAssistantMessage();
    expect(assistantMessage.content).toContain("Grass is green ");
    ...
    expect(updatedAssistantMessage.content).toContain("The sky appears blue ");
  });
  ...
  test.skip('upload file and send image attachment with message', async () => {
    ...
    const assistantMessage = await chatPage.getRecentAssistantMessage();
    expect(assistantMessage.content).toContain('This painting is by Monet');
  });
  ...
  test('call weather tool', async () => {
    ...
    expect(assistantMessage.content).toContain(
      'The current temperature in San Francisco ',
    );
  });
